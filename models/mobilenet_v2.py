# mostly borrowed from torchvision/models/mobilenet.py
...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, groups_in_1x1, use_flgc=False):
        ...
        # without conv+bn in shortcut it gives slightly less metric value
        self.shortcut = nn.Sequential()
        if self.stride == 1 and inp != oup:
            self.shortcut = nn.Sequential(
                nn.Conv2d(inp, oup, kernel_size=1, stride=1, padding=0, bias=False),  # TODO: add group conv here
                nn.BatchNorm2d(oup),
            )
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10, width_mult=1.0, inverted_residual_setting=None, round_nearest=8,
                 groups_in_1x1=1, use_flgc=False):
        """
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                features.append(block(input_channel, output_channel, stride, expand_ratio=t,
                                      groups_in_1x1=groups_in_1x1, use_flgc=use_flgc))
        ...
        # building classifier
        self.classifier = nn.Linear(self.last_channel, num_classes)  # with dropout it gives slightly less metric value
